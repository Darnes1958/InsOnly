...
class Repmain extends Page implements HasTable, HasForms
{
  ...
  protected static ?int $navigationSort=2;
    ...
    protected static string $view = 'filament.pages.repmain';
      ...
      ->schema([
        ...
        Actions::make([
          Action::make('طباعة')
            ...
            ->color('info')
            ->visible(fn() =>$this->main_id !=0)
            ->url(fn (): string => route('pdfmain', $this->main_id)),
