                            ...
                            <div class="inline-flex items-center space-x-1 rtl:space-x-reverse">
                                ...
                                @endif
                                    ...
                                    @if($column->getName() =='main_sum_over_kst')
                                        <input wire:model.live="over" class="text-sm w-32 font-medium px-0 mx-0 bg-transparent border-none" readonly/>
                                    @endif
                                    @if($column->getName() =='main_sum_tar_kst')
                                        <input wire:model.live="tar" class="text-sm w-32 font-medium px-0 mx-0 bg-transparent border-none" readonly/>
                                    @endif
                                    @if($column->getName() =='wrong_kst_sum_kst')
                                        <input wire:model.live="wrong" class="text-sm w-32 font-medium px-0 mx-0 bg-transparent border-none" readonly/>
                                    @endif
